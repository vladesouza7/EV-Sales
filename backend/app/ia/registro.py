...
REGISTRO: dict[str, Tool] = {
    ...
    "solicitar_aprovacao": Tool(
        nome="solicitar_aprovacao",
        descricao=(
            "Pede à gerente a condição e a reserva de um chassi. PARA a conversa até ela "
            "responder. Use só quando o cliente escolheu um carro específico. Você não "
            "define preço nem desconto: o valor é lido do sistema."
        ),
        parametros=_objeto({"chassi": {"type": "string"}}, ["chassi"]),
